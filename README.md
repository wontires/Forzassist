...
<img width="1280" height="480" alt="banner" src="https://github.com/user-attachments/assets/84aed8d6-f8b0-4bd0-bc18-5e7b2e37d05f" />
...
The installer will try to install ViGEmBus automatically if it is missing.
